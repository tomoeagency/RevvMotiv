...
function ReviewCard({
  ...
  return (
    <div className="group/card relative z-0 hover:z-20 flex-none w-[340px] h-[270px] bg-surface border border-hairline overflow-hidden rounded-2xl p-6 flex flex-col justify-between shadow-lg transition-all duration-500 ease-[var(--ease-brand)] hover:scale-[1.03] hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-red-500/10 hover:border-red-500/40">
      ...
      {/* 2. Review Comment Text (uniform clamped height) */}
      ...
      <div className="pt-4 border-t border-hairline flex items-center justify-between gap-3">
          ...
          <div className="min-w-0">
            ...
            {review.product ? (
              <Link
                ...
                className="text-[10px] font-semibold text-red-500 hover:text-red-400 truncate block transition-colors"
              >
        ...
        {/* Build Photo Thumbnail Pill (Uniform interactive badge) */}
        {photoUrl && (
          <button
            type="button"
