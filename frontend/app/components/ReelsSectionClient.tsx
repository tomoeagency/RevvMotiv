...
export function ReelsSectionClient({ embeds }: { embeds: InstagramEmbed[] }) {
  ...
  return (
    <section id="from-our-garage" className="border-t border-hairline py-24 bg-surface-alt relative overflow-hidden">
      ...
      <div className="max-w-screen-2xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-ink uppercase tracking-tight leading-[0.95]">
          ...
          >
            <a
              ...
              className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full bg-surface border border-hairline hover:border-red-500/50 hover:bg-neutral-900 transition-all text-xs font-bold text-ink shadow-sm group"
            >
              ...
              <span className="text-ink-muted text-[11px]">45K Followers</span>
            </a>
          </motion.div>
        </div>

        {/* If live embeds exist, show them; else render interactive Reel Cards */}
        {embeds.length > 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {GARAGE_GALLERY.map((reel, i) => (
              <motion.div
                ...
                className="group relative aspect-[9/16] rounded-2xl overflow-hidden bg-neutral-950 border border-hairline hover:border-red-500/60 shadow-xl hover:shadow-2xl hover:shadow-red-600/20 transition-all duration-500 cursor-pointer flex flex-col justify-between p-4"
              >
