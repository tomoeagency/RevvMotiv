...
export function FitmentProcessSection() {
  ...
  return (
    <section className="py-12 sm:py-20 md:py-24 bg-surface-alt border-y border-hairline relative overflow-hidden">
      ...
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <div className="lg:hidden flex overflow-x-auto pb-4 pt-1 gap-4 snap-x snap-mandatory scrollbar-none -mx-4 px-4">
          {STEPS.map((step, idx) => {
