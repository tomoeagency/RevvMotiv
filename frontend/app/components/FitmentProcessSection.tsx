...
import { Cpu, ShieldCheck, Wind, Wrench, ChevronLeft, ChevronRight } from "lucide-react";
...
export function FitmentProcessSection() {
  ...
  // Auto-advance step every 4.5s (pauses on user hover)
  useEffect(() => {
    if (isPaused) return;
  ...
  return (
    <section
      ...
      className="py-12 sm:py-16 md:py-20 bg-surface-alt border-y border-hairline relative overflow-hidden"
    >
      ...
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10 w-full">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-8 sm:mb-10 gap-4">
          ...
          {/* Phase Badge & Step Navigation Buttons */}
          <div className="flex items-center gap-3">
            ...
            <div className="hidden lg:flex items-center gap-1.5">
              <button
                ...
                className="w-8 h-8 rounded-lg bg-surface border border-hairline hover:border-red-500 hover:text-red-500 flex items-center justify-center text-ink transition-colors cursor-pointer"
              >
        ...
        {/* DESKTOP VIEW (lg+): Interactive Two-Column Experience with Click / Hover & Auto-Advance */}
                ...
                >
                  ...
                  {isActive && !isPaused && (
                    <div
                      ...
                      className="absolute bottom-0 left-0 h-0.5 bg-gradient-to-r from-red-600 via-red-500 to-red-400 animate-expand-width"
                      style={{
                  ...
                  {isActive && isPaused && (
                    <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-red-600 via-red-500 to-red-400" />
                  )}
